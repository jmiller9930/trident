# Project Trident — Governed Execution Playbook v1.1
...
document_id: TRIDENT-GOVERNED-EXECUTION-PLAYBOOK-v1.1
document_type: Handoff
sequence: PLAYBOOK-v1.1
status: Active
dependencies:
  - TRIDENT-MASTER-EXECUTION-GUIDE-v1.1
  - TRIDENT-FIX-006-MASTER-EXECUTION-GUIDE
langgraph_required: true
```

**Relationship:** This playbook is the **only** progression model for implementation. **`TRIDENT_MASTER_EXECUTION_GUIDE_v1_1.md`** holds dependency order and fix-injection timing; this document defines **how** each step is executed and proven.
...
**Not required:** Pre-reading the full **000A–000P** corpus.
...
Nike (**000P**, future implementation **100O**) routes events between workflow steps per Master Guide; **Read → Plan → Build → Prove → Review** is unchanged.
...
Apply **only** at injection points defined in **`TRIDENT_MASTER_EXECUTION_GUIDE_v1_1.md`** (§5):
...
- Phase 1 (including **100O** when issued, per Master Guide) and IDE track **100K–100N** are **accepted** under this playbook.
