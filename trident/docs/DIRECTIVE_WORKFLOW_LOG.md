...
|----|-----------|-------|------------------------------|--------------------|--------|
| W-029 | **100M** | Phase 2 — Read + Plan | **Step 1 Read** + **Step 2 Plan:** **`100M`** vs **`simulated-mutation`**; IDE patch layout; **FIX 003** gate blocks **`100M_PLAN` READY**. Log: **`WORKFLOW_LOG.md`** §100M. **Commit:** TBD. | **PENDING** — resolve **FIX 003** vs waiver | 2026-04-30 |
