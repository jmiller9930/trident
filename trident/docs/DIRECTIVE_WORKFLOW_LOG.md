...
| W-008 | **100F_FINAL** | Clawbot gate | Run `clawbot_100f_final_validation.py` (HTTP + DB + restart-low); `agent_role` case-insensitive for curl. See **`WORKFLOW_LOG.md`** §100F_FINAL. | **PENDING** — clawbot execution only. | 2026-04-30 |
