...
100A → 100B → 100C → 100D → 100E → 100F → 100G → 100H → 100I → 100J → 100U
...
100A → 100B → 100C → 100D → 100E → 100F → 100G → 100H → 100I → 100J → 100U; then 100K → 100L → 100M → 100N.
...
5. Continue **100E → 100F → 100G**; complete **100H → 100I → 100J → 100U** as needed; schedule **100R** and **FIX 005** before production **external LLM** reliance.  
